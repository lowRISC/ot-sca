...
def test():
    print("https://csrc.nist.gov/CSRC/media/Projects/Cryptographic-Standards-and-Guidelines/"
    ...
    key = b'\x40\x41\x42\x43\x44\x45\x46\x47\x48\x49\x4A\x4B\x4C\x4D\x4E\x4F\x50\x51\x52\x53\x54'\
          b'\x55\x56\x57\x58\x59\x5A\x5B\x5C\x5D\x5E\x5F'
    input = b'\x00\x01\x02\x03'
    customization = b'\x00'
    expected_output = b'\xE5\x78\x0B\x0D\x3E\xA6\xF7\xD3\xA4\x29\xC5\x70\x6A\xA4\x3A\x00\xFA\xDB'\
                      b'\xD7\xD4\x96\x28\x83\x9E\x31\x87\x24\x3F\x45\x6E\xE1\x4E'
