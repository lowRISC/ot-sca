...
from target.communication.fi_edn_commands import OTFIEDN
...
def fi_parameter_sweep(cfg: dict, target: Target, fi_gear,
                       project: FIProject, ot_communication: OTFIEDN) -> None:
    ...
    Args:
        ...
        ot_communication: The OpenTitan EDN FI communication interface.
    """
    # Configure the FI EDN code.
    ...
    with tqdm(total=remaining_iterations, desc="Injecting", ncols=80,
        ...
        while remaining_iterations > 0:
            ...
            if response == cfg["test"]["expected_result"]:
                ...
                ot_communication = OTFIEDN(target)
