...
from test.penetrationtests.fi.host_scripts import fi_rom_functions
...
class RomFiTest(unittest.TestCase):
    ...
    def test_char_rom_read(self):
        actual_result = fi_rom_functions.char_rom_read(opentitantool_path, iterations)
        actual_result_json = json.loads(actual_result)
        expected_result_json = json.loads(
            '{"digest":[0,0,0,0,0,0,0,0],"err_status":0,"alerts":[0,0,0],"ast_alerts":[0,0]}'
        )
