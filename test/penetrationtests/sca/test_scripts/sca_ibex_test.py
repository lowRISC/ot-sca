...
from test.penetrationtests.sca.host_scripts import sca_ibex_functions
...
class IbexScaTest(unittest.TestCase):
    ...
    def test_char_combi_operations_batch(self):
        for num_segments in num_segments_list:
            ...
            if fixed_data2 == 0:
                ...
                utils.to_signed32(fixed_data1) == -2147483648
                and utils.to_signed32(fixed_data2) == -1
            ):
                div = 0x80000000
            else:
                div = (
    ...
    def test_char_combi_operations_batch_fvsr(self):
        for num_segments in num_segments_list:
            ...
            if batch_data2 == 0:
                ...
                utils.to_signed32(batch_data1) == -2147483648
                and utils.to_signed32(batch_data2) == -1
            ):
                div = 0x80000000
            else:
                div = (
    ...
    def test_char_register_file_read(self):
        ...
        actual_result = sca_ibex_functions.char_register_file_read(opentitantool_path, iterations, data)
        actual_result_json = json.loads(actual_result)
    ...
    def test_char_register_file_read_batch_fvsr(self):
        for num_segments in num_segments_list:
            ...
            actual_result = sca_ibex_functions.char_register_file_read_batch_fvsr(
                opentitantool_path, iterations, fixed_data, num_segments
            )
            actual_result_json = json.loads(actual_result)
    ...
    def test_char_register_file_read_batch_random(self):
        for num_segments in num_segments_list:
            actual_result = sca_ibex_functions.char_register_file_read_batch_random(
                opentitantool_path, iterations, num_segments
            )
            actual_result_json = json.loads(actual_result)
    ...
    def test_char_register_file_write(self):
        data = [7, 6, 5, 4, 3, 2, 1, 0]
        actual_result = sca_ibex_functions.char_register_file_write(opentitantool_path, iterations, data)
        actual_result_json = json.loads(actual_result)
        expected_result_json = json.loads('{"result":0}')
        utils.compare_json_data(actual_result_json, expected_result_json, ignored_keys_set)
    ...
    def test_char_tl_read(self):
        ...
        actual_result = sca_ibex_functions.char_tl_read(opentitantool_path, iterations, data)
        actual_result_json = json.loads(actual_result)
        expected_result_json = json.loads('{"result":0}')
        utils.compare_json_data(actual_result_json, expected_result_json, ignored_keys_set)
    ...
    def test_char_tl_write(self):
        data = [255, 255, 255, 0, 0, 0, 0, 0]
        actual_result = sca_ibex_functions.char_tl_write(opentitantool_path, iterations, data)
        actual_result_json = json.loads(actual_result)
        expected_result_json = json.loads('{"result":0}')
        utils.compare_json_data(actual_result_json, expected_result_json, ignored_keys_set)
